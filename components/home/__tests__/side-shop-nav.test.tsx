...
describe("SideShopNav Component", () => {
  describe("Normal Mode", () => {
    ...
    it("should call addFollow when '+ Follow' is clicked for a non-followed seller", async () => {
      const addFollow = jest.fn().mockResolvedValue(true);
      const { removeFollow } = renderComponent({
        isLoggedIn: true,
        addFollow,
      });
    ...
    it("should call removeFollow when 'Unfollow' is clicked for a followed seller", async () => {
      const removeFollow = jest.fn().mockResolvedValue(true);
      const { addFollow } = renderComponent({
        isLoggedIn: true,
